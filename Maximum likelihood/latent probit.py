...
def OrderProbit5(betas): #faster version of above
...
rsqr = 1-(np.log(probit_est['fun'])/np.log(inter_est['fun']))
...
names =  [ 'logAGE',
 ...
 'Parents not Married',
 'ParentsMarriedOther',
 'Mother not born in canada',
 'MotherBirthOther',
 'Father not born in Can',
 'FatherBirthOther']

for i in range(len(names)):
    print '{0: <30}'.format(names[i]), b_estimates[i+4], "\t\t", SE[i+4], "\t", pval[i+4]
